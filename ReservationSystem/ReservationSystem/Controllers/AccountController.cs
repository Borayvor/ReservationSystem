...
using ReservationSystem.ViewModels.AccountViewModels;
...
namespace ReservationSystem.Controllers
{
  ...
  public class AccountController : Controller
  {
    ...
    public async Task<IActionResult> Logout()
    {
      ...
      return this.RedirectToAction(nameof(CalendarController.Index), typeof(CalendarController).GetControllerName());
    }
